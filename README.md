...
```bash
python main.py --model deeplabv3plus_mobilenet --enable_vis --vis_port 28333 --gpu_id 0 --year 2012 --crop_val --lr 0.01 --crop_size 513 --batch_size 16 --output_stride 16 --ckpt best_deeplabv3plus_mobilenet_voc_os16.pth --test_only --save_val_results
```
